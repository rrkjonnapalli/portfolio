export const user = {
  ...
  "skills": [
    "Node.js", "MongoDB", "Express", "Angular", "Git", "React",
    "Docker", "Python", "Kafka", "Apache Nifi"
  ],
  "summary": [
  ...
  "timeline": [
    {
      ...
      "about": "Owned the customer-facing Hub Connect Carrier application, designed and implemented Oracle OTM integrations, and developed a new LTL system to replace legacy workflows.\n",
      "responsibilities": [
    ...
    },
    {
      ...
      "about": "Reactor CX is a real-time, cloud-based application for executing pricing strategies and loyalty programs at scale. Built to be distributed in a SaaS model with high availability and extensibility.\n",
      "responsibilities": [
    ...
    },
    {
      ...
      "about": "Way2Online leads India’s martech industry, delivering large-scale, data-driven marketing solutions with advanced targeting and campaign management platforms.\n",
      "responsibilities": [
  ...
  "projects": [
    {
      ...
      "about": "An npm package to parse and simplify AJV schema validator error messages into clean, user-friendly outputs.\n"
    }
  ]
};